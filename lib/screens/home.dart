...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        // the menu reads best at phone width even inside the wide web
        // frame — work screens (board + photo) use the full width instead
        child: Align(
                    ...
                    children: [
                      ...
                      _ActionCard(
                        ...
                        onTap: () => Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) =>
                                const AnalysisScreen(editable: true),
                          ),
                        ),
                      ),
                      _ActionCard(
